...
$GLOBALS['TL_LANG']['site_details_type']['SL'] = 'Slowenisch';
$GLOBALS['TL_LANG']['site_details_type']['IT'] = 'Italienisch';


//$tl_content = \Controller::loadDataContainer('tl_content');
    ...
    'fields' => [
        ...
        'palettes' => [
           ...
           'wert1' =>   '{type_legend},type;'.
                        '{details_legend},speech,genericdatation,datation,region,position,sitesize,sitesizeareax,level,description;'.
